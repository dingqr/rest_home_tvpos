...
//    getTableQueryFakeData
    ...
    *  this.orderStatus = orderStatus;
    ...
    public static DataBean getDishBean() {
        ...
        dataBean.setDishName("油麦菜");
        dataBean.setPrice("22.00");
        ArrayList<DishLabelEntity> lables = new ArrayList<>();
        DishLabelEntity de1 = new DishLabelEntity("主厨推荐");
        DishLabelEntity de2 = new DishLabelEntity("热销");
        lables.add(de1);
        lables.add(de2);
        dataBean.setLabels(lables);
