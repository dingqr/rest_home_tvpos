...
/**
 * Created by ybing on 2017/8/3.
 * 小套餐列表数据适配器
 */

public class ADA_SetMealSmallList extends RecyclerView.Adapter<ADA_SetMealSmallList.ViewHolder> implements View.OnClickListener {
    private LayoutInflater mInflater;
    private List<SetMealListEntity> mDatas;

    public ADA_SetMealSmallList(Context mContext, List<SetMealListEntity> mDatas) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view;
        if (viewType == 0) {
            view = mInflater.inflate(R.layout.item_set_meal_small_no_add_cookery, viewGroup, false);
        } else {
            view = mInflater.inflate(R.layout.item_set_meal_small_add_cookery, viewGroup, false);
        }
        ...
        viewHolder.ibDishModify.setVisibility(View.GONE);
        return viewHolder;
    }
