 ...
 * 邮箱：lsf@yonyou.com
 */
public class PackingFragmentAdapter extends FragmentPagerAdapter {
    public final static int TAB_COUNT = 3;

    private Context mContext;
    private final String[] TITLES;

    public PackingFragmentAdapter(FragmentManager fragmentManager, Context context) {
        super(fragmentManager);
        this.mContext = context;
        TITLES = new String[]{ mContext.getString(R.string.packing_status_all), mContext.getString(R.string.packing_status_out_standing), mContext.getString(R.string.packing_status_checked_out)};
    }
