 ...
 * 描述：
 */
public class ADA_TakeOutOrderDetail extends CommonAdapterListView<OrderDishesEntity> {
    ...
    @Override
    protected void convert(ViewHolderListView viewHolder, OrderDishesEntity item, int position) {
