...
/**
 * 服务员点菜套餐弹框
 * 作者：ybing on 2017/7/26
 * 邮箱：ybing@yonyou.com
 */

public class DIA_SetMeal implements View.OnClickListener {
    /**上下文 */
    ...
    public DIA_SetMeal(Context mContext, ArrayList<SetMealListEntity> setMealListEntities) {
    ...
    private void initView() {
        ...
        mContentView = LayoutInflater.from(mContext).inflate(R.layout.dia_set_meal, null);
