 ...
 * wechat：18510829974
 * description：环形中空的统计图表 https://blog.csdn.net/qq_23286245/article/details/57413034
 */
public class CircleCenterEmptyChartView extends View {
    /**
     * 第一圈的颜色
     */
     ...
     * 剩余文字
     */
    private String reminderText = "未处理";
    /**
     * 进度文字
     */
    private String progressText = "已处理";
    /**
     * 中心x坐标
     */
    int centreX;
    ...
    public CircleCenterEmptyChartView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CircleCenterEmptyChartView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public CircleCenterEmptyChartView(Context context) {
        super(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 设置空心
        RectF oval = new RectF(centreX - radius, centerY - radius, centreX + radius, centerY + radius);
        // 用于定义的圆弧的形状和大小的界限
        mPaint.setColor(mFirstColor);
        // 设置圆环的颜色
        canvas.drawCircle(centreX, centerY, radius, mPaint);
        // 画出圆环
    ...
    /**
     * 计算百分比 * @param now * @param total * @return
     */
    ...
    /**
     * 设置当前进度 * @param total 总量 * @param now 当前进度量
     */
    ...
    /**
     * 绘制文字 * @param canvas * @param string * @param firstX * @param firstY * @param paint
     */
 ...
 * circularStatisticsView.setOnClickListener(this); circularStatisticsView.setReminderText("剩余");
 * circularStatisticsView.setProgressText("已使用"); circularStatisticsView.setProgress(15638,2546);
 * circularStatisticsView.setReminderColor(Color.parseColor("#FF0000FF"));
 * circularStatisticsView.setProgressColor(Color.parseColor("#FFFF0000")); circularStatisticsView.setCircleWidth(200);
 */