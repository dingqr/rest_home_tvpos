...
public class CurveGraphicView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        if (isMeasure) {
            ...
            blwidh = dip2px(30);
            Elog.e("TAG","canvasHeight=" + canvasHeight + "---bheight=" + bheight);
            isMeasure = false;
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        mPaint.setColor(res.getColor(R.color.color_4e4e4e));
        ...
        mPaint.setColor(res.getColor(R.color.color_5ffefd));
    ...
    private void drawText(String text, int x, int y, Canvas canvas) {
        ...
        p.setColor(res.getColor(R.color.color_red));
