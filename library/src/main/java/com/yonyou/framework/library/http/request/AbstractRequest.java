...
import com.yonyou.framework.library.http.annotation.HttpCacheExpire;
import com.yonyou.framework.library.http.annotation.HttpCacheKey;
import com.yonyou.framework.library.http.annotation.HttpCacheMode;
import com.yonyou.framework.library.http.annotation.HttpCharSet;
import com.yonyou.framework.library.http.annotation.HttpID;
import com.yonyou.framework.library.http.annotation.HttpMaxRedirect;
import com.yonyou.framework.library.http.annotation.HttpMaxRetry;
import com.yonyou.framework.library.http.annotation.HttpMethod;
import com.yonyou.framework.library.http.annotation.HttpSchemeHost;
import com.yonyou.framework.library.http.annotation.HttpTag;
import com.yonyou.framework.library.http.annotation.HttpUri;
