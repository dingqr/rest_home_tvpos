...
public class MaterialTextField extends FrameLayout {
    ...
    protected int labyonyouopMargin = -1;
    ...
    protected void onFinishInflate() {
        ...
        labyonyouopMargin = FrameLayout.LayoutParams.class.cast(label.getLayoutParams()).topMargin;
    ...
    public void expand() {
        if (!expanded) {
            ...
            animatorSet.playTogether(
                    ...
                    ObjectAnimator.ofFloat(label, "translationY", -labyonyouopMargin),
