package com.yonyou.framework.library.widgets;
...
/**
 * 
* @ClassName: ESwipeRefreshLayout
* @Description: 	
* @author lsf@yonyou.com
* @date Sep 22, 2015 4:44:44 PM
 */
public class ESwipeRefreshLayout extends SwipeRefreshLayout {

    public ESwipeRefreshLayout(Context context) {
        super(context);
    }

    public ESwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
